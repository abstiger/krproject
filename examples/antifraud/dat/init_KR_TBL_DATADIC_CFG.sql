...
insert into KR_TBL_DATADIC_CFG (DATADIC_ID, DATADIC_KEY, DATADIC_VALUE) values (100, '100001','ATM取现');
insert into KR_TBL_DATADIC_CFG (DATADIC_ID, DATADIC_KEY, DATADIC_VALUE) values (100, '100002','ATM转账');
insert into KR_TBL_DATADIC_CFG (DATADIC_ID, DATADIC_KEY, DATADIC_VALUE) values (100, '100003','POS消费');
commit;
